...
export default function DispatcherLoginScreen() {
    ...
    >
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.brandTagline}>Despachante</Text>
        </View>

        <View style={styles.form}>
          <Text style={styles.formTitle}>Console de Armazém</Text>

          <View style={styles.inputGroup}>
            <Text style={styles.inputLabel}>Email</Text>
            <TextInput
              style={styles.input}
              placeholder="despachante@entregapro.com"
        ...
        <Text style={styles.footer}>
          Console de operações logísticas © EntregaPRO
        </Text>
      </View>
    </KeyboardAvoidingView>
  );
...
const styles = StyleSheet.create({
  ...
  logoBox: {
    width: 72, height: 72, backgroundColor: '#2563EB', borderRadius: borderRadius.xl,
  ...
  brandTagline: { fontSize: 12, fontWeight: '700', color: '#2563EB', textTransform: 'uppercase', letterSpacing: 3, marginTop: 4 },
  form: {
  ...
  input: {
    ...
    borderRadius: borderRadius.lg, paddingHorizontal: 16, paddingVertical: 14,
    fontSize: 16, color: colors.text,
  },
  button: {
    backgroundColor: '#2563EB', borderRadius: borderRadius.lg, paddingVertical: 16,
